...
#data=x[:400]
#test_data=x[400:]
#lstmNet=LSTMNetwork(6,data,global_date_max) #25

#if os.path.isfile('sineTraining.sb'):
...
if os.path.isfile('lstmTraining.sb'):
