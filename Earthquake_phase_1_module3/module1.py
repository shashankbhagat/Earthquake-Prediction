...
if os.path.isfile('lstmTraining3.bv'):
    with open('lstmTraining1.bv','rb') as lstmRead:
        lstmNet=pickle.load(lstmRead)
else:
    print('would init')
    lstmNet.initialiseLSTMCells()
...
#save status of training in a file
with open('lstmTraining1.bv','wb') as lstmWrite:
    pickle.dump(lstmNet,lstmWrite)
###correct code ends
